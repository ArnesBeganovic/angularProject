...
var mainMenuComponent = (function () {
    ...
    //*****************************Constructor********************************
    //************************************************************************
    function mainMenuComponent(messageService) {
    ...
    mainMenuComponent.prototype.ngAfterContentInit = function () {
    ...
    mainMenuComponent.prototype.sendMessage = function (receiver, dataToSend) {
    ...
    mainMenuComponent.prototype.toggleClassOC = function (id) {
    ...
    mainMenuComponent.prototype.selectMenuItem = function (id, menuText) {
        for (var i = 0; i < this.menuBlocks.length; i++) {
            for (var j = 0; j < this.menuBlocks[i].subMenus.length; j++) {
